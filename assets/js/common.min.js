...
if ($('.sortby').length) {
  var minPrice = $('.sortby').data('minprice');
  var maxPrice = $('.sortby').data('maxprice');
  var maximum = parseInt(maxPrice) + (maxPrice * 0.1);

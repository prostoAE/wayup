...
<div id="one-click" class="click mfp-hide">
  <div id="popupOrder" class="click__form log order-form">
    <div class="click__half">
      ...
      <p class="click__text">Оставьте свои контакнтые данные и мы свяжемся с вами в ближайшее время для уточнения
        заказа</p>
      ...
      <div class="result">
        <div class="result__block">
          ...
          <div class="result__desc">
            ...
            <div class="quantity">
              <span class="minus-popup" data-link="<?php echo wc_get_cart_url(); ?>?add-to-cart=<?php echo get_the_ID(); ?>" data-price="<?php echo $product->get_price(); ?>">-</span>
              <input type="text" step="1" min="1" name="quantity" value="1" size="4" pattern="[0-9]*" class="valid" aria-invalid="false">
              <span class="plus-popup" data-link="<?php echo wc_get_cart_url(); ?>?add-to-cart=<?php echo get_the_ID(); ?>" data-price="<?php echo $product->get_price(); ?>">+</span>
            </div>

            <div class="result__cost">
              <p>Итого:</p><?php echo get_woocommerce_currency_symbol(); ?><span id="final-price"><?php echo $product->get_price(); ?></span>
            </div>

            <a href="<?php echo wc_get_cart_url(); ?>" id="add-popup-cart" class="click__link link-more">

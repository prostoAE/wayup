...
<section class="inner shop">
  <div class="shop-top"
       style="background: #fff url(<?php echo $wayup_options['woo_bg']['url']; ?>) no-repeat center top/ cover;">
    <div class="wrapper">
      <h1 class="shop-top__title">
        <?php echo $wayup_options['wootitle1']; ?><br><span><?php echo $wayup_options['wootitle2']; ?></span>
      </h1>
      <?php if ($wayup_options['woolink']) { ?>
        <a href="<?php echo $wayup_options['woolink']; ?>" class="shop-top__btn btn">Купить сейчас</a>
      <?php } ?>
    </div>
  </div>
  <div class="wrapper">

...
<form action="" method="post" id="displayMessage" class="cabinet__form" style="flex-wrap: wrap">
  <div class="avatar" style="width: 100%">
    <div class="avatar__img" style="margin: 0 auto">
      <img src="<?php echo get_avatar_url($user->ID, ['size' => 200]); ?>" alt="Личное фото">
  ...
  <div class="edit" style="width: 100%">
    ...
    <div class="edit__block">
      ...
      <div class="edit__group">
        ...
        <input type="text" name="account_first_name" class="edit__input"
               value="<?php echo esc_attr($user->first_name); ?>">
      </div>
      <div class="edit__group">
        <label><?php esc_html_e('Last name', 'woocommerce'); ?></label>
        <input type="text" name="account_last_name" class="edit__input"
               value="<?php echo esc_attr($user->last_name); ?>">
      </div>
      <div class="edit__group">
        <label><?php esc_html_e('Display name', 'woocommerce'); ?></label>
        <input type="text" name="account_display_name" class="edit__input"
      ...
      <div class="edit__group">
        <label>Телефон</label>
        <?php $user_phone = get_user_meta($user->ID, 'billing_phone', true); ?>
        <input type="tel" name="billing_phone" class="edit__input" value="<?php echo $user_phone; ?>">
      </div>
      ...
      <div class="edit__group show-pass">
        ...
        <input id="edit-pass" type="password" name="password_1" class="edit__input" autocomplete="off">
        <span class="edit__eye password-eye" data-target="#edit-pass">
          <svg width="34" height="22">
            <use xlink:href="#eye"/>
          </svg>
      ...
      <div class="edit__group show-pass">
        ...
        <input id="edit-pass" type="password" name="password_2" class="edit__input" autocomplete="off">
        <span class="edit__eye password-eye" data-target="#edit-pass">
          <svg width="34" height="22">
            <use xlink:href="#eye"/>
          </svg>

...
class Wayup_About_Widget extends WP_Widget {
  ...
  public function widget($args, $instance) {
    ...
    <div class="widget banner"
         style="background: url(<?php echo $image->get_image_src(); ?>) no-repeat center top/ cover;">
      ...
      <?php if ($link_more) : ?>
        <a href="<?php echo $link_more ?>" class="banner__btn <?php echo $link_anchor !== 'Купить' ? 'btn' : ''; ?>"><?php echo $link_anchor; ?></a>
      <?php endif; ?>
    </div>
    <?php
  }
  ...
  public function form($instance) {
    ...
    <p>
      ...
      <input type="text" class="widefat" id="<?php echo $this->get_field_id('link_anchor'); ?>"
             name="<?php echo $this->get_field_name('link_anchor'); ?>" value="<?php echo $instance['link_anchor']; ?>"/>
    </p>
    <p>
      <label>Image: </label>

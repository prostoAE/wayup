...
$args = array(
  ...
  'menu_title' => __('Wayup Options', 'wayup'),
  'page_title' => __('Wayup Super Options', 'wayup'),
...
$args['share_icons'][] = array(
  'url' => 'https://www.facebook.com/profile.php?id=100001809495788',
  'title' => 'Заходите на мой Фейсбук',
  'icon' => 'el el-facebook'
  //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
);

$args['share_icons'][] = array(
  'url' => 'https://www.youtube.com/channel/UCMnc87AvYJX4hV4ieDO65wg?view_as=subscriber',
  'title' => 'Подписывайтесь на меня',
  'icon' => 'el el-youtube'
  //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
);
...
Redux::setSection($opt_name, array(
  'title' => esc_html__('Contact Data Profiles', 'wayup'),
  'id' => 'contacts',
  'subsection' => true,
  'customizer_width' => '450px',
...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'type' => 'slides',
      'title' => __('Slides Options', 'wayup'),
      'subtitle' => __('Unlimited slides with drag and drop sortings.', 'wayup'),
      'desc' => __('This field will store all slides values into a multidimensional array to use into a foreach loop.', 'wayup'),
      'placeholder' => array(
        'title' => __('This is a title', 'wayup'),
        'description' => __('Description Here', 'wayup'),
        'url' => __('Give us a link!', 'wayup'),
      ),
    ),
  )
));
...
Redux::setSection($opt_name, array(
  'title' => esc_html__('Modal Windows', 'wayup'),
  'id' => 'modal_windows',
  'subsection' => true,
  'customizer_width' => '450px',
  'desc' => esc_html__('Add data', 'wayup'),
  'fields' => array(
    array(
      'id' => 'modal_contact_shortcode',
      'type' => 'text',
      'title' => esc_html__('Specify the Shortcode', 'wayup'),
      'default' => ''
    )
  )
));
...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'desc' => esc_html__('Установите плагин и введите шорткод контактной формы в это поле', 'wayup'),
      'default' => ''
    ),
  )
));
...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'default' => 'Вы хотите реализовать свои бизнес идеи?
Начало вашего нового бизнеса требует прочной юридической основы, и мы поможем вам на каждом этапе'
    ),
  )
));
...
Redux::setSection($opt_name, array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'type' => 'media',
      'url' => true,
      'title' => esc_html__('Background for Head Store', 'wayup'),
      'compiler' => 'true',
      'desc' => esc_html__('Upload image', 'wayup'),

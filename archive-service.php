  ...
  <section class="inner services tabs">
    <div class="wrapper">
      <h2 class="services__title secondary-title">
        <span><?php echo $wayup_options['servicearchivetitle1']; ?></span><br><?php echo $wayup_options['servicearchivetitle2']; ?>
      </h2>
            ...
            if ($services->have_posts()) :
              ...
              while ($services->have_posts()) : $services->the_post();
                ...
                if (get_metadata('post', get_the_ID(), 'wayup_service_icon', true)) {
                  $service_icon_bg_style = 'services__bg' . get_metadata('post', get_the_ID(), 'wayup_service_icon', true);
                  $service_icon_item_style = 'services__item' . get_metadata('post', get_the_ID(), 'wayup_service_icon', true);
                } else {
                ...
                <li class="services__item <?php echo $service_icon_item_style; ?>">
                  ...
                  <p class="services__descr"><?php echo get_the_excerpt(); ?></p>
                  <p class="services__price"><?php echo $wayup_options['servicecurrency'];
                    echo get_metadata('post', get_the_ID(), 'wayup_service_cost', true); ?></p>
